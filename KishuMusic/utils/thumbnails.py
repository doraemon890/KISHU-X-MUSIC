...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("KishuMusic/assets/kishu/font2.ttf", 30)
    font = ImageFont.truetype("KishuMusic/assets/kishu/font.ttf", 30)
    title_font = ImageFont.truetype("KishuMusic/assets/kishu/font3.ttf", 45)
    ...
    play_icons = Image.open("KishuMusic/assets/kishu/play_icons.png")
