...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"KishuMusic/assets/annie/{images}.png")
        ...
        font = ImageFont.truetype("KishuMusic/assets/annie/font2.ttf", 45)
        ImageFont.truetype("KishuMusic/assets/annie/font2.ttf", 70)
        arial = ImageFont.truetype("KishuMusic/assets/annie/font2.ttf", 30)
        ImageFont.truetype("KishuMusic/assets/annie/font.ttf", 30)
