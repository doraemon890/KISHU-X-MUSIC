...
from KishuMusic.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from KishuMusic import Carbon, app
from KishuMusic.utils.decorators.language import language, languageCB
from KishuMusic.utils.inline.playlist import (botplaylist_markup,
                                              get_playlist_markup,
                                              warning_markup)
...
from KishuMusic.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from KishuMusic import YouTube
